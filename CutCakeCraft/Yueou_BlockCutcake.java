...
public class Yueou_BlockCutcake extends Block{
	
	
    protected  Yueou_BlockCutcake(int par1, int par2)
    {
        super(par1, par2, Material.cake);
        this.setTickRandomly(true);
        this.setCreativeTab(CreativeTabs.tabFood);
        this.setTextureFile("/yueou/gui/cutcake.png");
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        float var6 = 0;//0.0625F;
        float var7 = (float)(1 + var5 * 2) / 16.0F;
        float var8 = 0.6F;//0.5F;
        this.setBlockBounds(var7-0.0625f, 0.0F, var6, 1.0F - var6, var8, 1.0F - var6);
    }
    ...
    {
        float var1 = 0;//0.0625F;
        float var2 = 0.6F;//0.5F;
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        float var7 = (float)(1 + var5 * 2) / 16.0F;
        float var8 = 0.6F;
        return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)((float)par2 + var7-0.0625F), (double)par3, (double)((float)par4 + var6), (double)((float)(par2 + 1) - var6), (double)((float)par3 + var8 - var6), (double)((float)(par4 + 1) - var6));
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        float var7 = (float)(1 + var5 * 2) / 16.0F;
        float var8 = 0.6F;
        return AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)((float)par2 + var7-0.0625F), (double)par3, (double)((float)par4 + var6), (double)((float)(par2 + 1) - var6), (double)((float)par3 + var8), (double)((float)(par4 + 1) - var6));
    }
    ...
    {
        if (true)//par5EntityPlayer.canEat(false))
        {
            par5EntityPlayer.getFoodStats().setFoodLevel(20);
            par5EntityPlayer.heal(20);
